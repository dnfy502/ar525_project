"""
MC-PILOT Config B: platform height +0.5 m (z_release = 1.0 m)
AR525 Group-3, IIT Mandi

Identical to Config A (test_mc_pilot.py) except the robot platform is raised
0.5 m, giving a release height of 1.0 m above ground.
Max reachable range with drag: ~1.97 m  →  lM = 1.90 m.
"""
...
# Log directory
# ---------------------------------------------------------------------------
log_path = "results_mc_pilot_b/" + str(seed)
