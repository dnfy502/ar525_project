"""
MC-PILOT Config C: platform height +1.0 m (z_release = 1.5 m)
AR525 Group-3, IIT Mandi

Identical to Config A (test_mc_pilot.py) except the robot platform is raised
1.0 m, giving a release height of 1.5 m above ground.
Max reachable range with drag: ~2.23 m  →  lM = 2.15 m.
"""
...
# Log directory
# ---------------------------------------------------------------------------
log_path = "results_mc_pilot_c/" + str(seed)
