"""
MC-PILOT Config D-Strat: platform height +1.5 m, stratified exploration
AR525 Group-3, IIT Mandi

Same as Config D (z_release=2.0m, lM=2.35m) but uses Stratified_Throwing_Exploration.
...
# Log directory
# ---------------------------------------------------------------------------
log_path = "results_mc_pilot_d_strat/" + str(seed)
