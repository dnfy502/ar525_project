"""
MC-PILOT Config E: platform height -0.5 m (z_release = 0.0 m)
AR525 Group-3, IIT Mandi

Identical to Config A (test_mc_pilot.py) except the robot platform is lowered
0.5 m, giving a release height of 0.0 m (ground level).
The ball is launched from ground level: it arcs upward and lands back at z=0.
Max reachable range with drag: ~1.16 m  →  lM = 1.10 m.
"""
...
# Log directory
# ---------------------------------------------------------------------------
log_path = "results_mc_pilot_e/" + str(seed)
