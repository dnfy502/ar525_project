"""
MC-PILOT Config E-Strat: platform height -0.5 m, stratified exploration
AR525 Group-3, IIT Mandi

Same as Config E (z_release=0.0m, lM=1.10m) but uses Stratified_Throwing_Exploration.
...
# Log directory
# ---------------------------------------------------------------------------
log_path = "results_mc_pilot_e_strat/" + str(seed)
