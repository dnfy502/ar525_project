...
% ─── Title block ─────────────────────────────────────────────────────────────
\title{\textbf{Geometry, Noise, and Disturbances:\\
...
\input{sections/convergence_rules}
\input{sections/study1_height}
\input{sections/study2_multiarm}
\input{sections/study3_noise}
\input{sections/study4_wind}
\input{sections/study5_vision}
