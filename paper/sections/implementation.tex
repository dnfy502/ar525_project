...
cost $c_T = 1 - \exp(-\|\mathbf{e}_T\|^2 / \ell_c^2)$ evaluated these non-physical, out-of-distribution states,
...
near-zero-gradient region of~\eqref{eq:cost_lc}.
...
and crashing the process before any gradient computation could begin.
